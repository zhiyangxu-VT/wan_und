...
torchrun --nproc_per_node=8 \
    ...
    --bf16 True \
    --data_list $DATA_DIR/nano_banana/Nano-150k/json/Times-Change_cleaned.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/action_cleaned.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/background_cleaned.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/black_headshot_cleaned.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/hairstyle_cleaned.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/sweet_headshot_cleaned.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/reconstruct/Times-Change_cleaned_reconstruct_v2.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/reconstruct/action_cleaned_reconstruct_v2.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/reconstruct/background_cleaned_reconstruct_v2.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/reconstruct/black_headshot_cleaned_reconstruct_v2.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/reconstruct/hairstyle_cleaned_reconstruct_v2.jsonl,$DATA_DIR/nano_banana/Nano-150k/json/reconstruct/sweet_headshot_cleaned_reconstruct_v2.jsonl,$DATA_DIR/X2I2/jsons/inpaint_edit/
    --data_list_weights 10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,1,1,1,10,10,2,2 \
    --run_name discrete_x2i_2node_5e-5_image_id_vae_as_noise_and_cross_attn_reproduce \
    --output_dir /fsx/sfr/data/lxue/training_ckpts/blip3o_next/discrete_x2i_2node_5e-5_image_id_vae_as_noise_and_cross_attn_reproduce \
    --num_train_epochs 1 \
    ...
    --use_und_image_vae True \
    --dataloader_pin_memory False \
    --use_und_image_vae_as_noise True \
    --only_use_und_image_vae_as_noise False
